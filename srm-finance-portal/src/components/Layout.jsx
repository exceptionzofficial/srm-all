...
import { FiUsers, FiDollarSign, FiLogOut, FiMenu, FiFileText, FiClipboard, FiPieChart } from 'react-icons/fi';
...
const Layout = () => {
    ...
    const CURRENT_USER_ID = user.employeeId || 'FINANCE-ADMIN-DEFAULT'; // Fallback to avoid 404s
        ...
        <div className="layout">
            <aside className={`sidebar ${sidebarOpen ? 'open' : 'closed'}`}>
                ...
                <nav>
                    ...
                    <NavLink to="/salary" className={({ isActive }) => isActive ? 'active' : ''}>
                        <FiDollarSign /> Salary Processing
                    </NavLink>
                    <NavLink to="/requests" className={({ isActive }) => isActive ? 'active' : ''}>
                        <div className="nav-item-content">
                            <span><FiFileText /> Other Requests</span>
                            {pendingCount > 0 && (
            ...
            <main className="content">
                ...
                <header className="top-bar">
                    ...
                    <span style={{ fontWeight: 500 }}>Welcome, Finance Admin</span>
                </header>
