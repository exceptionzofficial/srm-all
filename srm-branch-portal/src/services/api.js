...
export const sendMessage = async (groupId, messageData) => {
    // Check if messageData is FormData (for file uploads)
...
export const createGroupTask = async (groupId, taskData) => {
    // Deprecated: Tasks are now stored in the group object itself via updateGroup
    console.warn("createGroupTask is deprecated. Use updateGroup instead.");
    return { success: false, message: "Use updateGroup" };
};

export const updateGroupTask = async (groupId, taskId, updates) => {
    // Deprecated
    console.warn("updateGroupTask is deprecated. Use updateGroup instead.");
    return { success: false, message: "Use updateGroup" };
};
