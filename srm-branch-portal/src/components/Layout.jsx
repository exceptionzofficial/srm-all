...
import { FiUsers, FiDollarSign, FiLogOut, FiMenu, FiFileText, FiClipboard, FiPieChart, FiSettings, FiMap } from 'react-icons/fi';
        ...
        <div className="layout">
            ...
            <main className="content">
                ...
                <header className="top-bar">
                    ...
                    <span style={{ fontWeight: 500 }}>Welcome, Branch Manager</span>
                </header>
