...
const Layout = () => {
    ...
    const CURRENT_USER_ID = user.employeeId || 'RETAIL-ADMIN-DEFAULT'; // Fallback to avoid 404s
        ...
        <div className="layout">
            <aside className={`sidebar ${sidebarOpen ? 'open' : 'closed'}`}>
                <div className="logo-area">
                    ...
                    <h2>Retail Manager Portal</h2>
                </div>
                <nav>
                    <NavLink to="/" className={({ isActive }) => isActive ? 'active' : ''}>
                        <FiPieChart /> Branch Overview
                    </NavLink>
            ...
            <main className="content">
                ...
                <header className="top-bar">
                    ...
                    <span style={{ fontWeight: 500 }}>Welcome, Retail Manager</span>
                </header>
